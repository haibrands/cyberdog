...
###############################################################################################################
# [Warning]:
# We may or may not decide to come back and brush up on this script at times, but it is by no means regularly updated for vulnerabilities/bugs. It is also 100% not the most efficient script out there for reconnaissance/enumeration. Use for fun!
###############################################################################################################
...
def opening(): #Opening function with introduction of the script along with the various scans used.
    ...
    print ("\nThis program can run for a long time! The UDP scan has been limited to the top 50 ports. You also have the option to disable the nikto scan which would take the longest.")
